...
export function BottomSheet({ open, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 lg:flex lg:items-center lg:justify-center lg:bg-ink/40 lg:p-6">
      ...
      >
        <div
          className="animate-slide-up-in flex max-h-[90vh] w-full flex-col gap-4 overflow-y-auto rounded-t-3xl bg-surface p-6 lg:max-h-[640px] lg:w-[420px] lg:rounded-2xl lg:shadow-xl"
